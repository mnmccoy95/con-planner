    ...
    const constructBudgetObject = () => {
            ...
            if (window.location.href.includes("edit")){
                ...
                editBudget({
                    ...
                    travelExpenses: parseInt(budget.travelExpenses),
        ...
        <form className="budgetForm">
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" id="allowance" name="allowance" autoFocus className="form-control" 
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" id="foodCost" name="foodExpenses" className="form-control" 
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" id="merchCost" name="merchExpenses" className="form-control" 
            ...
            <fieldset>
                <div className="form-group">
                    ...
                    <input type="text" id="travelCost" name="travelExpenses" className="form-control" 
